...
function runGame(deltaTime)
{
	...
	if (player.y > SCREEN_WIDTH + player.height)
	{
		player.y = 0;
	}
	...
	if (asteroids.x < 0)
	{
		asteroids.x = SCREEN_WIDTH;
	}
	
	if (asteroids.x > SCREEN_WIDTH + asteroids.width)
	{
		asteroids.x = 0;
	}
	...
	if (asteroids.y < 0)
	{
		asteroids.y = SCREEN_WIDTH;
	}
	
	if (asteroids.y > SCREEN_WIDTH + asteroids.height)
	{
		asteroids.y = 0;
	}
